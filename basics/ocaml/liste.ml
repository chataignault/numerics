...
let tete = function [] -> failwith "liste vide" | h :: t -> h
let queue = function [] -> failwith "liste vide" | h :: t -> t
...
let rec insere x n l =
  if n = 1 then x :: l
  else (*insere avant le n-ieme element*)
    match l with
    | [] -> failwith "liste trop courte"
...
let rec concatenation l1 l2 =
  match l1 with [] -> l2 | a :: l -> a :: concatenation l l2
...
(*Bon point de vue*)
let rec vider l1 l2 = match l1 with [] -> l2 | a :: l -> vider l (a :: l2)
