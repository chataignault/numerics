...
void test12() {
  ...
  std::cout << "Number of instances at the end of test 1.2 = "
            << Expression::nb_instances() << std::endl;
...
void test132() {
  ...
  Nombre n{3};
  Variable x{"x"};
  Addition a{new Nombre(5), new Variable("y")};
...
void test2() {
  ...
  std::cout << "Number of instances : " << SmartExpression::nb_instances()
            << std::endl;
...
int main(int argc, char *argv[]) {
  std::cout << "Number of instances at the beginning of main = "
            << Expression::nb_instances() << std::endl;
  test12();
  test131();
  test132();
  ...
  test3();
  std::cout << std::endl
            << "Number of instances at the end of main = "
            << Expression::nb_instances() + SmartExpression::nb_instances()
            << std::endl;
}
